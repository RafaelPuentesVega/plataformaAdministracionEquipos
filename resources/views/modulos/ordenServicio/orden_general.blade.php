                ...
                <div class="container-fluid">
                    <div class="row ">
                        ...
                        <div class="table-responsive-xl">
                            <table class="table " style="webkit-font-smoothing: antialiased;
                                ...
                                <thead class="thead-light">
                                    ...
                                    <tr >
                                        ...
                                        <th width="10%" style="font-size: 12px ;font-weight:normal;  text-align: center
                                                ; border: rgba(0, 0, 0, 0.089) 1.5px solid">
                                            &nbsp;<strong>Cedula</strong>

                                        </th>
                                        <th width="24%" style="font-size: 12px ;font-weight:normal;  text-align: center
                                            ; border: rgba(0, 0, 0, 0.089) 1.5px solid">
                                        ...
                                        <th width="11%" style="font-size: 11px ;font-weight:normal;  text-align: center
                                            ; border: rgba(0, 0, 0, 0.089) 1.5px solid">
                                            &nbsp;<strong>Valor Servicio</strong>

                                        </th>
                                        <th width="8%" style="font-size: 12px ;font-weight:normal;  text-align: center
                                            ; border: rgba(0, 0, 0, 0.089) 1.5px solid">
                                            &nbsp;<strong>IVA</strong>
                                        ...
                                        <th width="3%" style="font-size: 12px ;font-weight:normal;  text-align: center
                                            ; border: rgba(0, 0, 0, 0.089) 1.5px solid">
                                ...
                                <tbody>
                                    @foreach ($ordenServicio as $OrdenServicio)
                                        ...
                                        @if ($OrdenServicio->fecha_estimada_orden < date('Y-m-d') && $OrdenServicio->estadoOrden == 1)
                                            <tr class="table-danger" style="background-color: #E74C3C">
                                                {{-- {{-- ORDEN VENCIDA --}}
                                            @elseif($OrdenServicio->estadoOrden == 1)
                                            <tr class="table" style="background-color: #faefff7e">
                                                {{-- {{-- ORDEN RECIEN INGRESO --}}
                                            @elseif($OrdenServicio->estadoOrden == 2)
                                            <tr class="table-success" style="background-color: #28B463">
                                                {{-- {{-- ORDEN LISTA PARA ENTREGAR --}}
                                            @elseif($OrdenServicio->estadoOrden == 3 && $OrdenServicio->factura_numero_orden == null)
                                            <tr class="table" style="background-color: #FFFF00">
