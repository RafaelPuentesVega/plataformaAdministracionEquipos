...
<html lang="es">
    <head>
        ...
        <link href="<?php echo url('assets/css/bootstrap.min.css?v=1'); ?>" rel="stylesheet" />
        <link href="<?php echo url('bootstrap/preloader.css?v=1'); ?>" rel="stylesheet" />
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo url('assets/css/bootstrap-extended.min.css?v=1'); ?>">
    ...
    padding: 20%">
        ...
        <div class="lds-ring" style="margin-bottom: -100%">
           ...
           <script src="<?php echo url('assets/js/light-bootstrap-dashboard.js?v=1.4.0'); ?>"></script>
            ...
            <script src="<?php echo url('js/preloader.js?v=1.3'); ?>"></script>
